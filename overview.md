...
# outdent_if_last_expected_child (left child row of each parent column)

| (Child) Parent > | Root      | Arg       | Bool      | Comment   | Const     | ConstRef  | Float     | FnCall | FnDef     | If  | InFnCall | InFnDef   | Int       | List | Loop | Rust      | String    | Struct | StructEdit | Type      | Assign    | Eol       | FnDefWIP | Indent    | LoopWIP | Parens | Println | Seol | Unused |
| :--------------- | :-------- | :-------- | :-------- | :-------- | :-------- | :-------- | :-------- | :----- | :-------- | :-- | :------- | :-------- | :-------- | :--- | :--- | :-------- | :-------- | :----- | :--------- | :-------- | :-------- | :-------- | :------- | :-------- | :------ | :----- | :------ | :--- | :----- |
| Root             | n/a error |           |           |           |           |           |           |        |           |     |          |           |           |      |      |           |           |        |            |           |           |           |          |           |         |        |         |      |        |
| Arg              |           | n/a error |           |           |           |           |           |        |           |     |          |           |           |      |      |           |           |        |            |           |           |           |          |           |         |        |         |      |        |
| Bool             |           |           | n/a error |           |           |           |           |        |           |     |          |           |           |      |      |           |           |        |            |           |           |           |          |           |         |        |         |      |        |
